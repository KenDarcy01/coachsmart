            ...
            body: SafeArea(
              ...
              child: Align(
                ...
                child: Stack(
                  ...
                  children: [
                    if (_model.apiEventDetails != null)
                      Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children:
                                            List.generate(dynamicMembers.length,
                                                (dynamicMembersIndex) {
                                                                      ...
                                                                      return ListView
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          final childrenAcceptedItem =
                                                                              childrenAccepted[childrenAcceptedIndex];
                                                                          return Text(
                                                                            '${valueOrDefault<String>(
                                                                              childrenAcceptedItem.roleNamePlural,
                                                                              'role_name',
                                                                            )}: ${valueOrDefault<String>(
                                                                              childrenAcceptedItem.memberCount.toString(),
                                                                              'role_level',
                                                                            )}',
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                      ...
                                                                      return ListView
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          final childrenNoResponseItem =
                                                                              childrenNoResponse[childrenNoResponseIndex];
                                                                          return Text(
                                                                      ...
                                                                      return ListView
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          final childrenDeclinedItem =
                                                                              childrenDeclined[childrenDeclinedIndex];
                                                                          return Text(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      RichText(
                                                                        ...
                                                                        text:
                                                                          ...
                                                                          children: [
                                                                            TextSpan(
                                                                              text: (int varTotalPayments, int varTotalAccepted) {
                                                                                return varTotalAccepted == 0 ? "0%" : (varTotalPayments / varTotalAccepted * 100.0).round().toString() + '%';
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            percent: ((UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.newNumPayments / UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.acceptedPlayerCount)) > 1.0
                                                                                ? 1.0
                                                                                : ((UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.newNumPayments / UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.acceptedPlayerCount)),
                                                                            lineHeight:
                                                                                12.0,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          TextSpan(
                                                                            text:
                                                                                (int varAmount, int varAccepted) {
                                                                              return "€" + (varAccepted == 0 ? "0.00" : ((varAmount * varAccepted) / 100).toStringAsFixed(2));
                                                                            }(UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.paymentAmount, UserEventDetailsStruct.maybeFromMap(eventDetailsGetUserEventDetailsResponse.jsonBody)!.acceptedPlayerCount),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.inter(
                                                                                    fontWeight: FontWeight.bold,
                                                                                    fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
