...
class _CreateEventWidgetState extends State<CreateEventWidget> {
  ...
  void initState() {
    ...
    _model.eventOppositionInputTextController ??= TextEditingController();
    _model.eventOppositionInputFocusNode ??= FocusNode();

    _model.eventTitleInputTextController ??= TextEditingController();
    _model.eventTitleInputFocusNode ??= FocusNode();

    _model.switchRecurringEventValue = false;
    _model.numberWeeksInputTextController ??= TextEditingController();
    _model.numberWeeksInputFocusNode ??= FocusNode();

    _model.eventMeetTimeInputTextController ??= TextEditingController();
    _model.eventMeetTimeInputFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: GetUserEventCreateDetailCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final createEventGetUserEventCreateDetailResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CREATE_EVENT_keyboard_backspace_ICN_ON_T');
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return Wrap(
                                  ...
                                  children:
                                      List.generate(childrenTeamsWrap.length,
                                          (childrenTeamsWrapIndex) {
                                    final childrenTeamsWrapItem =
                                        childrenTeamsWrap[
                                            childrenTeamsWrapIndex];
                                    return FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CREATE_EVENT_PAGE_Button_ltmj6sbe_ON_TAP');
                                        logFirebaseEvent(
                                            'Button_update_page_state');
                                        _model.stateEventTeamID =
                                            childrenTeamsWrapItem.teamId;
                                        safeSetState(() {});
                                      },
                                      text: valueOrDefault<String>(
                                        childrenTeamsWrapItem.teamName,
                                        'team_name',
                                      ),
                          ...
                          children: [
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return Align(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'CREATE_EVENT_PAGE_Button_xi3aep36_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_update_page_state');
                            ...
                            if (_model.stateEventTypeID == 2)
                              Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.eventOppositionInputTextController,
                                  focusNode:
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CREATE_EVENT_PAGE_Row_49rsu1bf_ON_TAP');
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Switch.adaptive(
                                    value: _model.switchRecurringEventValue!,
                            ...
                            if (_model.switchRecurringEventValue == true)
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CREATE_EVENT_PAGE_EVERY_WEEK_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_update_page_state');
                                            _model.stateRecurringWeek = 1;
                                            safeSetState(() {});
                                          },
                                          text: 'Every Week',
                                          options: FFButtonOptions(
                                            ...
                                            iconPadding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 0.0),
                                            color: _model.stateRecurringWeek ==
                                                    1
                                                ? FlutterFlowTheme.of(context)
                                                    .coachSmartGreen
                                                : FlutterFlowTheme.of(context)
                                      ...
                                      Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CREATE_EVENT_EVERY_SECOND_WEEK_BTN_ON_TA');
                                            logFirebaseEvent(
                                                'Button_update_page_state');
                                            _model.stateRecurringWeek = 2;
                                            safeSetState(() {});
                                          },
                            ...
                            if (_model.stateEventTypeID == 2)
                              Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.eventMeetTimeInputTextController,
                                  focusNode: _model.eventMeetTimeInputFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return Align(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'CREATE_EVENT_PAGE_Button_34mc3925_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_update_page_state');
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Switch.adaptive(
                                    value: _model.switchRequestAttendanceValue!,
                                    onChanged: (newValue) async {
                                      safeSetState(() =>
                                      ...
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Missing Data'),
                                            content: Text(
                                                'Please fill out the mandatory data'),
                                            actions: [
                                              TextButton(
