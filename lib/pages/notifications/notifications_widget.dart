                                                                          ...
                                                                          if ((childNotificationsItem.action != 'approve_member') &&
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) => InkWell(
                                                                                ...
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('NOTIFICATIONS_PAGE_Icon_01ex6d50_ON_TAP');
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          onPressed: (childNotificationsItem.isRead == true)
                                                                              ? null
                                                                              : () async {
                                                                                  logFirebaseEvent('NOTIFICATIONS_PAGE_APPROVE_BTN_ON_TAP');
                                                                    ...
                                                                    children: [
                                                                      FFButtonWidget(
                                                                        onPressed: (childNotificationsItem.isRead ==
                                                                            ...
                                                                            ? null
                                                                            : () async {
                                                                                logFirebaseEvent('NOTIFICATIONS_EVENT_DETAILS_BTN_ON_TAP');
                                                                                logFirebaseEvent('Button_backend_call');
