      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADMIN_OPTIONS_chevron_left_ICN_ON_TAP');
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if ((_model.apiPopulateNotifications
                                        ...
                                        logFirebaseEvent('Button_backend_call');
                                        _model.apiUpdateAdminDetail =
                                            await GetEventAdminDetailsCall.call(
                                          supabaseJWTtoken: currentJwtToken,
                                          pEventId: widget.eventID,
                                        );
                                        ...
                                        FFAppState().eventAdminDetail =
                                            EventAdminDetailStruct.maybeFromMap(
                                                (_model.apiUpdateAdminDetail
                                                        ?.jsonBody ??
                                                    ''))!;
                                        safeSetState(() {});
