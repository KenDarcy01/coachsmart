...
import 'games_ages_model.dart';
export 'games_ages_model.dart';

class GamesAgesWidget extends StatefulWidget {
  const GamesAgesWidget({super.key});

  static String routeName = 'GamesAges';
  static String routePath = 'gamesAges';

  @override
  State<GamesAgesWidget> createState() => _GamesAgesWidgetState();
}

class _GamesAgesWidgetState extends State<GamesAgesWidget> {
  late GamesAgesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GamesAgesModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'GamesAges'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('GAMES_AGES_PAGE_chevron_left_ICN_ON_TAP');
