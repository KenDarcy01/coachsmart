                ...
                if (FFAppState().homePageEvents.userOnboarded == true)
                  RefreshIndicator(
                    ...
                    onRefresh: () async {
                      ...
                      if ((_model.outputHomeLoadRefresh?.succeeded ?? true)) {
                        if (UserEventsHomeStruct.maybeFromMap(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            if (eventChildrenItem.requestAttendance ==
                                                                                true)
                                                                              Padding(
