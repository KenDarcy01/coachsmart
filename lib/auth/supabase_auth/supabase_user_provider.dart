...
class CoachSmartV2SupabaseUser extends BaseAuthUser {
  CoachSmartV2SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> coachSmartV2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CoachSmartV2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
