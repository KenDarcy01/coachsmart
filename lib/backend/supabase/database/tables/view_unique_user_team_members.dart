...
class ViewUniqueUserTeamMembersTable
    extends SupabaseTable<ViewUniqueUserTeamMembersRow> {
  @override
  String get tableName => 'view_unique_user_team_members';

  @override
  ViewUniqueUserTeamMembersRow createRow(Map<String, dynamic> data) =>
      ViewUniqueUserTeamMembersRow(data);
}

class ViewUniqueUserTeamMembersRow extends SupabaseDataRow {
  ViewUniqueUserTeamMembersRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewUniqueUserTeamMembersTable();
