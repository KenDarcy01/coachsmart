...
class ViewUserUniqueMemberTeamEventsTable
    extends SupabaseTable<ViewUserUniqueMemberTeamEventsRow> {
  @override
  String get tableName => 'view_user_unique_member_team_events';

  @override
  ViewUserUniqueMemberTeamEventsRow createRow(Map<String, dynamic> data) =>
      ViewUserUniqueMemberTeamEventsRow(data);
}

class ViewUserUniqueMemberTeamEventsRow extends SupabaseDataRow {
  ViewUserUniqueMemberTeamEventsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewUserUniqueMemberTeamEventsTable();
