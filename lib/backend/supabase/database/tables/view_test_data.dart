...
class ViewTestDataTable extends SupabaseTable<ViewTestDataRow> {
  @override
  String get tableName => 'view_test_data';

  @override
  ViewTestDataRow createRow(Map<String, dynamic> data) => ViewTestDataRow(data);
}

class ViewTestDataRow extends SupabaseDataRow {
  ViewTestDataRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTestDataTable();
