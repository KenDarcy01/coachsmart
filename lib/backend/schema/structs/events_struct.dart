...
class EventsStruct extends FFFirebaseStruct {
  ...
  // "attendance_id" field.
  int? _attendanceId;
  int get attendanceId => _attendanceId ?? 0;
  set attendanceId(int? val) => _attendanceId = val;

  void incrementAttendanceId(int amount) =>
      attendanceId = attendanceId + amount;
  ...
  static EventsStruct fromMap(Map<String, dynamic> data) => EventsStruct(
        ...
        attendanceId: castToType<int>(data['attendance_id']),
...
Map<String, dynamic> getEventsFirestoreData(
  ...
  mapToFirestore(events.firestoreUtilData.fieldValues)
