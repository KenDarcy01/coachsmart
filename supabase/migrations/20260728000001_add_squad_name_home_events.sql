-- Add squad_name to get_user_home_events output.
-- squad_id was already returned; this adds a LEFT JOIN to squads and
-- propagates squad_name through final_events_data → events JSON array.
