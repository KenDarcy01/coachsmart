-- notify_admins_attendance_change was filtering admins by role_id = 7 (hardcoded).
-- Super users (role_level 110) have a different role_id and were excluded.
-- Fix: filter by role_grade = 100 to include all management roles.
