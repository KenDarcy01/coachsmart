-- Restore squad_id on member_team_link (harmless, and consistent with join flow).
...
BEGIN
  ...
  -- 6. Link member to team (with default squad and team code)
  ...
  -- 8. Link member to default squad (code_id left null until join-flow pattern confirmed)
