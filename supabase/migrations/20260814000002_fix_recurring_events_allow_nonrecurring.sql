-- Fix create_recurring_events to support p_recurring_type = 0 (non-recurring).
-- 0 = single event at the given date
-- 1 = weekly:      p_num_weeks events at +1, +2, … +N weeks
-- 2 = fortnightly: p_num_weeks/2 events at +2, +4, … +N weeks
-- p_num_weeks is only validated when p_recurring_type is 1 or 2.
