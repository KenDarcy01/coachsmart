-- get_member_analytics v4:
-- 1. Add team_female to teams so frontend can remap Hurling → Camogie.
-- 2. Add event_code and event_type to matchSelections so code/type chips filter them too.
