-- notify_admins_attendance_change was inserting is_read=true for email-only
-- admins (no FCM token), meaning those notifications were born already-read
-- and never appeared as unread in the app.
-- Fix: always insert is_read=false, matching the pattern already applied to
-- populate_event_notifications in migration 20260817000013.
