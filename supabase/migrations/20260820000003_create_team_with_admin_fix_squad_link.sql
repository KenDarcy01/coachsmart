-- Remove squad_id from member_team_link insert — the app reads member_squad_link,
-- not the squad_id column on member_team_link.
...
BEGIN
  ...
  INSERT INTO member_team_link (member_id, team_id, member_team_code, status)
  VALUES (v_member_id, v_team_id, v_team_code, 'active')
