...
abstract class FlutterFlowTheme {
  ...
  late Color coachSmartGreen;
  late Color coachSmartDarkBlack;
  late Color coachSmartLightBlack;
  late Color coachSmartWhite;
  late Color coachSmartMidBlack;
  late Color coachSmartGrey;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color coachSmartGreen = const Color(0xFF87C232);
  late Color coachSmartDarkBlack = const Color(0xFF040506);
  late Color coachSmartLightBlack = const Color(0xFF1E222B);
  late Color coachSmartWhite = const Color(0xFFE0E3E7);
  late Color coachSmartMidBlack = const Color(0xFF15181E);
  late Color coachSmartGrey = const Color(0xFFA3A3A3);
}
