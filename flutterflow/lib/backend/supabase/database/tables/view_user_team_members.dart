...
class ViewUserTeamMembersTable extends SupabaseTable<ViewUserTeamMembersRow> {
  @override
  String get tableName => 'view_user_team_members';

  @override
  ViewUserTeamMembersRow createRow(Map<String, dynamic> data) =>
      ViewUserTeamMembersRow(data);
}

class ViewUserTeamMembersRow extends SupabaseDataRow {
  ViewUserTeamMembersRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewUserTeamMembersTable();
