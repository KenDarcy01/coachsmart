...
class ViewUserMembersTable extends SupabaseTable<ViewUserMembersRow> {
  @override
  String get tableName => 'view_user_members';

  @override
  ViewUserMembersRow createRow(Map<String, dynamic> data) =>
      ViewUserMembersRow(data);
}

class ViewUserMembersRow extends SupabaseDataRow {
  ViewUserMembersRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewUserMembersTable();
