...
class _CheckoutSuccessWidgetState extends State<CheckoutSuccessWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CheckoutSuccess'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CHECKOUT_SUCCESS_CheckoutSuccess_ON_INIT');
      logFirebaseEvent('CheckoutSuccess_custom_action');
      _model.outputSupabaseToken = await actions.fetchSupabaseAccessToken();
      logFirebaseEvent('CheckoutSuccess_backend_call');
      _model.outputSessionDetails = await GetCheckoutSessionDetailsCall.call(
        supabaseAccessToken: _model.outputSupabaseToken,
        sessionId: widget.stripeSessionId,
      );

      if ((_model.outputSessionDetails?.succeeded ?? true)) {
        logFirebaseEvent('CheckoutSuccess_update_page_state');
        _model.varSessionLoaded = true;
        safeSetState(() {});
      }
    });
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Visibility(
            visible: _model.varSessionLoaded == true,
            child: Align(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                'Your receipt has been sent to your registered email address from stripe',
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                        ...
                        children: [
                          Expanded(
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CHECKOUT_SUCCESS_PAGE_CLOSE_BTN_ON_TAP');
